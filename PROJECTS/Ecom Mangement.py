...
print('\nProducts you have selected are:\n', selected_products)
...
class update_iventory():
    ...
    def change_in_quanitity(self):
        ...
        return f'\n{self.quantity_change} stocks are left!!'
    ...
    def discount_process(self):
        if self.discount_type == 'percentage':
            if self.discount_code == 'NEWUSER20':
                ...
                print('\nthe amount with 20 percent discount is:\n',final_amount)
                return final_amount
...
status = Update_Order_Status('123',{'status':'Processing --> Shipped'},{'expected delivery':'18th June,2025','Id':'BP789123456IN'})
...
order_id = input("Enter your Order ID: ")#123
